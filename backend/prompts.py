...
OUTPUT_CONTRACT = f"""EXPLANATION: <one plain-English paragraph, 50 words or fewer, saying what the queries return and how they match the question. No SQL jargon.>
